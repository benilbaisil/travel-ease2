...
function sendVerificationEmail($recipientEmail, $verificationCode) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'benilbaisil001@gmail.com';
        $mail->Password   = 'nwbb afwj tfay xcmd';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        $mail->setFrom('benilbaisil001@gmail.com', 'Travel ease');
...
<head>
    ...
    <title>Travel ease - OTP Verification</title>
...
<body>
    <div class="login-container">
        <div class="logo">
            <span class="task">Travel</span><span class="mate">ease</span>
        </div>
